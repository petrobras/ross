...
def test_crack_mayes_kc(crack_mayes):
    assert crack_mayes.kc == pytest.approx(
        ...
        np.array(
            [
                [3.30362822e08, 1.90566722e07, -4.61655368e05, 4.91833707e06],
                [1.90566722e07, 2.73811859e08, -3.54836778e06, 4.61655368e05],
                [-4.61655368e05, -3.54836778e06, 8.59606031e04, -1.11837826e04],
                [4.91833707e06, 4.61655368e05, -1.11837826e04, 1.19148647e05],
            ]
        )
        # fmt: on
    )
