...
def test_example1_w_equals_0rpm():
    ...
    ROT.run()
    assert ROT.wn == pytest.approx(np.array([86.66, 86.66, 274.31, 274.31, 716.78, 716.78]), 1e-3)


def test_example1_w_equals_4000rpm():
    ROT = rotor_example1(4000*np.pi/30, 6)
    ROT.run()
    assert ROT.wn == pytest.approx(np.array([85.39, 87.80, 251.78, 294.71, 600.18, 827.08])
                                                                , 1e-3)
...
def test_example2_w_eq_0rpm():
    ...
    ROT.run()
    assert pytest.approx(ROT.wn, 1e-3) == np.array([90.14, 90.14, 630.73, 630.73, 830.43, 830.43])


def test_example2_w_eq_4000rpm():
    ROT = rotor_example2(4000*np.pi / 30, 6)
    ROT.run()
    assert pytest.approx(ROT.wn, 1e-3) == np.array([76.19, 103.91, 565.99,
...
def test_example3_w_equals_0rpm():
    ...
    ROT.run()
    assert pytest.approx(ROT.wn, 1e-3) == np.array([82.65, 86.66, 254.52, 274.31, 679.49, 716.79])


def test_example3_w_equals_4000rpm():
    ROT = rotor_example3(4000*np.pi/30, 48)
    ROT.run()
    assert pytest.approx(ROT.wn, 1e-3) == np.array([82.33, 86.86, 239.64, 287.25, 583.49,
                                                                                 806.89])
