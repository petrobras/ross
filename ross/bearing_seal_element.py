...
class MagneticBearingElement(BearingElement):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.ks = ks
        self.ki = ki
        # self.integral = [0, 0]  # TODO: Remover. Não serão mais necessários, já que temos o estado do controlador
        # self.e0 = [0, 0]
        self.control_signal = []
    ...
    # TODO: Ajustar o docstring
    # TODO: Implementar um método de teste para levar em consideração a implementação de um controlador geral
    def compute_pid_amb(self, current_offset, setpoint, disp, dof_index):
        ...
        err = setpoint - disp
        u = (
            self.C_c * self.x_c[dof_index] + self.D_c * err
        )  # T0D0: Reescrever utilizando array e não matrix
