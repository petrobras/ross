...
from ross.interface.domain.requests import ANALYSIS_REQUEST, MODE_SHAPE_REQUEST
from ross.interface.services.worker.jobs import (
    CANCELLED,
    DONE,
    FAILED,
    JOBS,
...
from ross.interface.services.worker.resident import raise_if_refused
