...
from ross.interface.services.worker.compare import (  # noqa: E402
    DIFFERENT,
    IDENTICAL,
    compare,
)
...
def run():
    from ross.interface.domain.analysis_catalog import ANALYSES, default_params
    from ross.interface.domain.cache import ANALYSIS_CACHE
    from ross.interface.selftest import ROTOR
    from ross.interface.services.analysis.pipeline import figure_json
