...
def _the_page_is_there():
    from ross.interface.api.paths import FRONTEND_DIR
...
def _the_charting_library_is_there():
    from ross.interface.api.paths import PLOTLY_BUNDLE
...
def _every_analysis_answers():
    ...
    from ross.interface.api.waiting import answer_for
