...
if "--worker" in sys.argv:
    from ross.interface.services.worker.child import main as serve_as_worker  # noqa: E402

    sys.exit(serve_as_worker())

from ross.interface.api import HOST, PORT, create_app  # noqa: E402
...
def main():
    ...
    if "--worker-check" in sys.argv:
        from ross.interface.services.worker.check import run
