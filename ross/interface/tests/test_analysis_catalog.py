...
from ross.interface.domain.analysis_catalog import (
    ANALYSES,
    ROSS_METHOD,
    fields,
    catalog,
)
from ross.interface.services.analysis import REGISTRY
from ross.interface.tests.test_runners import (
    PARAMS as PARAMS_BASE,
    SpyParams,
    FakeRotor,
)
...
def _runner_source(name):
    ...
    modules = [
        ...
        sys.modules["ross.interface.services.analysis.base"],
    ]
...
def test_the_screen_offers_exactly_what_the_catalogue_has():
    ...
    from ross.interface.tests.frontend_source import source
...
def test_the_javascript_fixture_matches_the_catalogue():
    ...
    from ross.interface.domain.analysis_catalog import titles
