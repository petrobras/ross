...
from ross.interface.tests.frontend_source import FRONTEND, ROOT, modules, relative

DOCS_STATIC = os.path.join(os.path.dirname(os.path.dirname(ROOT)), "docs", "_static")
