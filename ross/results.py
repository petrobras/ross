...
class SummaryResults(Results):
    ...
    def plot(self, length_units="m", mass_units="kg", force_units="N"):
        ...
        disk_data = {
            ...
            "Nodal Position (" + length_units + ")": pd.Series(
