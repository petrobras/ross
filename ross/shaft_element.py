...
class ShaftTaperedElement(Element):
    ...
    def M(self):
        ...
        ...                         shear_effects=True)
        >>> Timoshenko_Element.M()[:4, :4]
        array([[11.36019439,  0.        ,  0.        ,  0.86139914],
               [ 0.        , 11.36019439, -0.86139914,  0.        ],
               [ 0.        , -0.86139914,  0.08654813,  0.        ],
               [ 0.86139914,  0.        ,  0.        ,  0.08654813]])
        """
        phi = self.phi
        L = self.L
        a1 = self.a1
    ...
    def G(self):
        ...
        ...                         shear_effects=True)
        >>> Timoshenko_Element.G()[:4, :4]
        array([[ 0.        ,  0.26269332,  0.00582265,  0.        ],
               [ 0.26269332,  0.        ,  0.        , -0.00582265],
               [-0.00582265,  0.        ,  0.        ,  0.00623696],
               [ 0.        ,  0.00582265,  0.00623696,  0.        ]])
        """
