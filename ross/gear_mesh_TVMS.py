...
class GearElementTVMS(DiskElement):
    ...
    def __init__(
        ...
        pr_angle=Q_(20, 'deg').to_base_units(),
        addendum_coeff=1,
        ...
        self.pressure_angle     = float(pr_angle) #[rad]
...
def gear_mesh_stiffness_example() -> None:
    material_ma = Material("teste_2", rho=Q_(7.82,'g/cm**3'), E=Q_(212,'GPa'), Poisson=0.29)
    gear1 = GearElementTVMS(n=21, material=material_ma, m=Q_(12*2.204,'lbs'), module=Q_(2, 'mm'), width=Q_(20,'mm'), n_tooth=55, hub_bore_radius=Q_(17.5,'mm'))
    gear2 = GearElementTVMS(n=21, material=material_ma, m=Q_(12*2.204,'lbs'), module=Q_(2/25.4, 'in'), width=Q_(20,'mm'), n_tooth=75, hub_bore_radius=Q_(17.5, 'mm'))
...
def evaluate_stiffness() -> None:
    material_ma = Material("teste_2", rho=Q_(7.82,'g/cm**3'), E=Q_(212,'GPa'), Poisson=0.29)
    gear1 = GearElementTVMS(n=21, material=material_ma, m=Q_(12*2.204,'lbs'), module=Q_(2, 'mm'), width=Q_(20,'mm'), n_tooth=55, hub_bore_radius=Q_(17.5,'mm'))
    
    gear1_tau = np.linspace(gear1.geometry_dict['alpha_a'], gear1.geometry_dict['alpha_c'], int(1e2))
